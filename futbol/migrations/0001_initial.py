# Generated by Django 5.2 on 2026-03-10 14:45
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('equip_local', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='partits_local', to='futbol.equip')),
                ('equip_visitant', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='partits_visitant', to='futbol.equip')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('equip', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to='futbol.equip')),
                ('jugador', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='events_fets', to='futbol.jugador')),
                ('jugador2', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='events_rebuts', to='futbol.jugador')),
